        ...
        <div class="ibox-content p-xl">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <!-- $dieta->pohlavie -->
                    <div class="form-group">
                        <label class="col-md-4 control-label">Pohlavie:</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label">Dátum narodenia:</label>
                        <div class="col-md-8">
                    ...
                    <!-- $dieta->rok_narodenia -->
                    <div class="form-group">
                        <label class="col-md-4 control-label">Rok narodenia:</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label">Rodinný stav:</label>
                        <div class="col-md-8">
                    ...
                    <!-- $dieta->skola->nazov -->
                    <div class="form-group">
                        <label class="col-md-4 control-label">Škola:</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label">Škola - dátum nastavenia:</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label">Prekladá sa list:</label>
                        <div class="col-md-8">
                ...
                <div class="col-md-6">
                    ...
                    <!-- $dieta->misia->nazov -->
                    <div class="form-group">
                        <label class="col-md-4 control-label">Misia:</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label">Dôvod ukončenia:</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label">Pozastavené do:</label>
                        <div class="col-md-8">
