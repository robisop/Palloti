        ...
        <div class="ibox-content p-xl">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <!-- $rodic->je_institucia -->
                    <div class="form-group">
                        <label class="col-md-2 control-label">Je inštitúcia:</label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label">Názov spoločnosti:</label>
                        <div class="col-md-10">
                    ...
                    <!-- $rodic->oslovenie -->
                    <div class="form-group">
                        <label class="col-md-2 control-label">Titul, oslovenie:</label>
                        <div class="col-md-10">
                    ...
                    <!-- $rodic->telefon -->
                    <div class="form-group">
                        <label class="col-md-2 control-label">Telefón:</label>
                        <div class="col-md-10">
                    ...
                    <!-- $rodic->telefon2 -->
                    <div class="form-group">
                        <label class="col-md-2 control-label">Telefón 2:</label>
                        <div class="col-md-10">
                    ...
                    <!-- $rodic->iban -->
                    <div class="form-group">
                        <label class="col-md-2 control-label">Číslo účtu:</label>
                        <div class="col-md-10">
                ...
                <div class="col-md-6">
                    ...
                    <!-- $rodic->adresa->psc -->
                    <div class="form-group">
                        <label class="col-md-2 control-label">PSČ:</label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label">Posielať časopis:</label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label">Posielať poďakovania:</label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label">Spôsob komunikácie:</label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label">Dátum podpisu zmluvy:</label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label">Dátum ukončenia:</label>
                        <div class="col-md-10">
