...
@section('content')
    ...
    <div class="wrapper wrapper-content">
        <div class="ibox-content p-xl">
            {!! Form::open(['route' => ['platba.destroy', $platba->id], 'method' => 'delete', 'class' => 'form-horizontal']) !!}
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <a class="btn btn-primary" href="{{ route('platba.edit', $platba->id) }}">Upraviť</a>
                    <a class="btn btn-default" href="{{ route('platba.index') }}">Späť na zoznam</a>
                </div>
            </div>
